...
public class Galeria extends javax.swing.JFrame {
    ...
    public Galeria() {
        initComponents();
        super.setTitle("Galeria");
        super.setResizable(true);
        super.setLocationRelativeTo(null);
        Map<Integer, JLabel> dictionary = new HashMap<>();
        for (int i = jSlider1.getMinimum(); i <= jSlider1.getMaximum(); i++) {
            dictionary.put(i, new JLabel((i + 1) + ""));
        }
        jSlider1.setLabelTable(new Hashtable(dictionary));
//        URL url = new URL("asdasd");
//        ImageIcon icon = new ImageIcon(ImageIO(url));
    }
    ...
    private String ImageIO(URL url) {
